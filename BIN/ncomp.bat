...
@echo  "----------------------------------------------------------------------"
@echo on
%JAVA_HOME%\bin\java -Xint -DJA_HOME=%JA_HOME% -DORACLE_HOME=D:\oracle\product\10.2.0\db_1 -DJA_LIBS_HOME=D:\oracle\product\10.2.0\db_1 -DJAVA_HOME=%JAVA_HOME% -DJAVA_HOME_CLASSPATH=%JAVA_HOME_CLASSPATH% -classpath %JACLASSPATH% oracle.jaccelerator.Ncomp %args% 
@echo off
goto finish
