...
set DBG=REM
set JA_HOME=D:\oracle\product\10.2.0\db_1\javavm\jahome
set redirect_to_log_file=true
set args=
set nextarg=""
set jreclasspath="D:\oracle\product\10.2.0\db_1\lib\aurora_client.jar;D:\oracle\product\10.2.0\db_1\jlib\javax-ssl-1_1.jar;D:\oracle\product\10.2.0\db_1\jlib\jssl-1_1.jar;D:\oracle\product\10.2.0\db_1\lib\jasper.zip;D:\oracle\product\10.2.0\db_1\lib\vbjtools.jar;D:\oracle\product\10.2.0\db_1\lib\vbjorb.jar;D:\oracle\product\10.2.0\db_1\lib\vbjapp.jar;D:\oracle\product\10.2.0\db_1\javavm\lib\aurora.zip;D:\oracle\product\10.2.0\db_1\lib\xmlparserv2.jar;D:\oracle\product\10.2.0\db_1\jdbc\lib\classes12.jar"
pushd .
:LOOP
...
set JACLASSPATH="%JA_HOME%;D:\oracle\product\10.2.0\db_1\javavm\lib\jaccelerator.zip;D:\oracle\product\10.2.0\db_1\javavm\lib\ncomp.zip;%JAVA_HOME_CLASSPATH%"
set JACLASSPATH="%JACLASSPATH:"=%"

if (%redirect_to_log_file%)==(true) goto MARK8
@echo  "----------------------------------------------------------------------"
@echo on
%JAVA_HOME%\bin\java -Xint -DJA_HOME=%JA_HOME% -DORACLE_HOME=D:\oracle\product\10.2.0\db_1 -DJA_LIBS_HOME=D:\oracle\product\10.2.0\db_1 -DJAVA_HOME=%JAVA_HOME% -DJAVA_HOME_CLASSPATH=%JAVA_HOME_CLASSPATH% -classpath %JACLASSPATH% oracle.jaccelerator.Deploy %args% 
@echo off
goto finish
